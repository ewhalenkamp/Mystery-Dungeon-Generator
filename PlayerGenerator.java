...
public class PlayerGenerator {
    ...
    public void drawMiniPlayer(Player player) {
        StdDraw.setPenColor(StdDraw.RED);
        double smallc = .1;
        int relativePlayerx = 50;
        int relativePlayery = -150;
        StdDraw.filledRectangle(player.getx()*smallc+player.getx()+relativePlayerx+12.5*smallc, player.gety()*smallc+player.gety()+12.5*smallc+relativePlayery, 8*smallc, 8*smallc);
    }
